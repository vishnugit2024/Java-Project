...
public class DeleteCustomer extends JFrame {
	...
	public DeleteCustomer() throws SQLException {
		setBounds(480, 120, 850, 600);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/delete.png"));
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
                                ResultSet rs = c.s.executeQuery("select * from customers where username = 'Praveen456'");
                                if(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
	    			String uv = c1.getSelectedItem(); 
                                
                                String q1 = "Delete from customers where username = '"+uv+"'";
