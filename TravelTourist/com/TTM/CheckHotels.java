package com.TTM;
	...
	public class CheckHotels extends JFrame implements Runnable {
	    ...
	    public CheckHotels() {
	        ...
	        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel1.jpg"));
	        ...
	        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel2.jpg"));
	        ...
	        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel3.jpg"));
	        ...
	        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel4.jpg"));
	        ...
	        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel1.jpg"));
	        ...
	        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel5.jpg"));
	        ...
	        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel6.jpg"));
	        ...
	        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel7.jpg"));
	        ...
	        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel8.jpg"));
	        ...
	        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons-20/icons/hotel9.jpg"));
